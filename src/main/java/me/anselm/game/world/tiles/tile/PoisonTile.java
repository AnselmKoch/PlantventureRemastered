...
public class PoisonTile extends Tile {
    public PoisonTile(Vector3f position, float width, float height, float size,Position center) {
        super(position, width, height, size, AssetStorage.getTexture("poison"), center);

        this.setLootTable(new LootTable(PoisonBulletItem.class, 50, 2));
    }
    ...
    public void onInteract(Player player) {
        ...
        HUDRenderer.drawInformation(200, "OP Projectiles!");
    }
}
