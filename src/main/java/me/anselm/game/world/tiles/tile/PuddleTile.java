...
public class PuddleTile extends Tile {
    ...
    public PuddleTile(Vector3f position, float width, float height, float size, Position center) {
        super(position, width, height, size, AssetStorage.getTexture("puddle"), center);

        this.setLootTable(new LootTable(WaterBulletItem.class, 50, 10));
    }
    ...
    public void onInteract(Player player) {
        ...
        HUDRenderer.drawInformation(200, "Aimbot projectiles!");
    }
}
